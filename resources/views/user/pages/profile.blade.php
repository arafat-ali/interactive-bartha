...
<!--            <span class="bottom-2 right-4 absolute w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>-->
        ...
        <!-- User Meta -->
        <div>
          <h1 class="font-bold md:text-2xl">{{$data->firstName . ' ' .$data->lastName }}</h1>
      ...
      <div
        ...
        <div class="flex flex-col justify-center items-center">
          <h4 class="sm:text-xl font-bold">{{$data->total_posts}}</h4>
          <p class="text-gray-600">Posts</p>
        </div>

        <!-- Total Comments Count -->
        <div class="flex flex-col justify-center items-center">
          <h4 class="sm:text-xl font-bold">{{$data->total_comments}}</h4>
      ...
      <div>
        <div class="flex items-start /space-x-3/">
          ...
          <div class="text-gray-700 font-normal w-full">
            <textarea class="block w-full p-2 pt-2 text-gray-900 rounded-lg border-none outline-none focus:ring-0 focus:ring-offset-0"
                name="title"
                rows="2"
